...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'circadian.cli': { 'circadian.cli.main_acto': ('cli.html#main_acto', 'circadian/cli.py'),
            ...
            'circadian.lights': { 'circadian.lights.LightSchedule': ('lights.html#lightschedule', 'circadian/lights.py'),
                                  'circadian.lights.LightSchedule.RegularLight': ( 'lights.html#lightschedule.regularlight',
                                                                                   'circadian/lights.py'),
                                  'circadian.lights.LightSchedule.ShiftWorkLight': ( 'lights.html#lightschedule.shiftworklight',
                                                                                     'circadian/lights.py'),
