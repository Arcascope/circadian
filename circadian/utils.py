...
# %% auto 0
__all__ = ['phase_difference', 'amplitude_percent_change', 'utc_to_hrs', 'phase_ic_guess', 'abs_hour_diff', 'cut_phases_12',
           'convert_binary', 'cal_days_diff', 'parse_dt', 'phase_coherence', 'phase_coherence_clock',
           'angle_difference', 'subtract_clock_times', 'times_to_angle']
